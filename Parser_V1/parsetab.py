...
_lr_productions = [
  ...
  ('programa -> condicion','programa',1,'p_programa','AnalizadorSintactico.py',22),
  ('condicion -> expresion','condicion',1,'p_condicion','AnalizadorSintactico.py',26),
  ('expresion -> termino','expresion',1,'p_expresion','AnalizadorSintactico.py',32),
  ('termino -> factor','termino',1,'p_termino','AnalizadorSintactico.py',37),
  ('factor -> PARIZQ expresion PARDER','factor',3,'p_factor','AnalizadorSintactico.py',42),
  ('factor -> IF condicion THEN programa ELSE programa ENDIF','factor',7,'p_factor','AnalizadorSintactico.py',43),
  ('factor -> ID','factor',1,'p_factor_ID','AnalizadorSintactico.py',48),
  ('factor -> LET ID IGUAL expresion IN programa ENDLET','factor',7,'p_factor_LET','AnalizadorSintactico.py',52),
  ('factor -> LET ID ENTERO IGUAL expresion IN programa ENDLET','factor',8,'p_factor_LET','AnalizadorSintactico.py',53),
  ('expresion -> expresion MAS termino','expresion',3,'p_expresion_MAS','AnalizadorSintactico.py',59),
  ('expresion -> expresion MENOS termino','expresion',3,'p_expresion_MENOS','AnalizadorSintactico.py',63),
  ('termino -> factor MULTIPLICACION expresion','termino',3,'p_termino_MULTIPLICACION','AnalizadorSintactico.py',67),
  ('termino -> factor DIVISION expresion','termino',3,'p_termino_MULTIPLICACION','AnalizadorSintactico.py',68),
  ('expresion -> COMENTARIO','expresion',1,'p_expresion_Comentario','AnalizadorSintactico.py',73),
  ('condicion -> expresion MAYOR expresion','condicion',3,'p_condicion_Relacional','AnalizadorSintactico.py',77),
  ('condicion -> expresion MENOR expresion','condicion',3,'p_condicion_Relacional','AnalizadorSintactico.py',78),
  ('condicion -> expresion MAYORIGUAL expresion','condicion',3,'p_condicion_Relacional','AnalizadorSintactico.py',79),
  ('condicion -> expresion MENORIGUAL expresion','condicion',3,'p_condicion_Relacional','AnalizadorSintactico.py',80),
  ('condicion -> expresion IGUALIGUAL expresion','condicion',3,'p_condicion_Relacional','AnalizadorSintactico.py',81),
  ('condicion -> expresion DIFERENTE expresion','condicion',3,'p_condicion_Relacional','AnalizadorSintactico.py',82),
  ('factor -> ENTERO','factor',1,'p_factor_ENTERO','AnalizadorSintactico.py',95),
  ('factor -> DECIMAL','factor',1,'p_factor_DECIMAL','AnalizadorSintactico.py',99),
  ('expresion -> expresion PTCOMA','expresion',2,'p_expresion_SignosPuntuacion','AnalizadorSintactico.py',103),
]
